...
from .aiomusiccast.musiccast_data import Category
...
_CATEGORY_TO_DEVICE_CLASS: dict[Category, MediaPlayerDeviceClass] = {
...
_DEVICE_CLASS_TO_ICON: dict[MediaPlayerDeviceClass, str] = {
    MediaPlayerDeviceClass.RECEIVER: "mdi:audio-video",
...
class MusicCastMediaPlayer(MusicCastDeviceEntity, MediaPlayerEntity):
    ...
    def device_class(self) -> MediaPlayerDeviceClass | None:
        """Return the device class based on the category reported by the device."""
        return _CATEGORY_TO_DEVICE_CLASS.get(self.coordinator.data.category)

    @property
    def icon(self) -> str:
        """Return an icon matching the device class."""
        return _DEVICE_CLASS_TO_ICON.get(self.device_class, "mdi:speaker")
